...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5535552,
    DYNAMIC_BASE = 5535552,
    DYNAMICTOP_PTR = 292640;
...
var real__loop_handler = asm["_loop_handler"];
asm["_loop_handler"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__loop_handler.apply(null, arguments);
};
...
var _loop_handler = Module["_loop_handler"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_loop_handler"].apply(null, arguments)
};
